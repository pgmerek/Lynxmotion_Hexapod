...
class Leg(object):
  ...
  def angle_to_pwm(self, angle, motor):
    if(motor == TIP_MOTOR):
      ...
      return linear_map(self.ROT_MOTOR_FOR_ANGLE, self.ROT_MOTOR_FOR, self.ROT_MOTOR_BACK_ANGLE, self.ROT_MOTOR_BACK, angle)
    else:
      return INV_PARAM
  ...
  def pwm_to_angle(self, pwm, motor):
    if(motor == TIP_MOTOR):
      ...
      return linear_map(self.ROT_MOTOR_FOR, self.ROT_MOTOR_FOR_ANGLE, self.ROT_MOTOR_BACK, self.ROT_MOTOR_BACK_ANGLE, pwm)
    else:
      return INV_PARAM
