...
# NOTE: these are only used in debugging so it is not NECESSARY to add entries but it might be good
MOVE_DESCRIPTIONS = {
        NORMAL_NEUTRAL : "basic position",
        NORMAL_TRI_RIGHT_NEUTRAL_LEFT_UP_NEUTRAL : "right neutral, left is up",
        NORMAL_TRI_RIGHT_BACK_LEFT_UP_FORWARD : "right back, left is up",
        NORMAL_TRI_RIGHT_BACK_LEFT_FORWARD : "right back, left down and forward",
        NORMAL_TRI_RIGHT_UP_BACK_LEFT_FORWARD : "right up, left forward",
        NORMAL_TRI_RIGHT_UP_NEUTRAL_LEFT_NEUTRAL : "right up, left neutral",
        NORMAL_TRI_RIGHT_UP_FORWARD_LEFT_BACK : "right up, left back",
        NORMAL_TRI_RIGHT_FORWARD_LEFT_BACK : "right down and forward, left back",
        NORMAL_TRI_RIGHT_FORWARD_LEFT_UP_BACK : "right forward, left up",

        NORMAL_TRI_RIGHT_RIGHT_LEFT_UP_LEFT : "right is right, left is up",
        NORMAL_TRI_RIGHT_RIGHT_LEFT_LEFT : "right is right, left is left",
        NORMAL_TRI_RIGHT_UP_RIGHT_LEFT_LEFT : "right is up, left is left",
        NORMAL_TRI_RIGHT_UP_LEFT_LEFT_RIGHT : "right is up, left is right",
        NORMAL_TRI_RIGHT_LEFT_LEFT_RIGHT : "right is left, left is right",
        NORMAL_TRI_RIGHT_LEFT_LEFT_UP_RIGHT : "right is left, left is up"
        }
